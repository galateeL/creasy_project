...
<head>
    ...
    <link rel="stylesheet" href="/css/prospect/add.css"/>
...
<div>
    ...
    <div class="fluid-container col-12 justify-content-center">
        ...
        <div class="ms-md-4 me-md-5 d-flex flex-column flex-md-row align-items-center justify-content-center justify-content-md-between">
            ...
            <h1 class="mt-3 fw-bold ms-md-5 align-self-center text-break">Edit prospect : ${prospect.lastname} ${prospect.firstname} </h1>
        ...
        <div class="col row m-5 p-3">
            ...
            <form class="col-12 " action="${pageContext.request.contextPath}/partners/edit-prospect/${prospect.id}" method="POST"
                ...
                <div class="d-flex flex-column flex-md-row justify-content-between">
                    ...
                    <div class="col col-md-5 p-5 bg-white">
                        ...
                        <div class="mb-3">
                            ...
                            <input id="positionHeld-p" name="positionHeld" type="text" class="form-control" value="${prospect.positionHeld}">
                        </div>
